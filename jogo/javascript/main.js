...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (_c = document.getElementById('add-terra')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => {
        const itemTerra = new Itens("Terra", 10, "Bloco");
        meuJogo.adicionarItem(itemTerra);
    });
    // Botão para adicionar Picareta
    (_d = document.getElementById('add-picareta')) === null || _d === void 0 ? void 0 : _d.addEventListener('click', () => {
    ...
    (_e = document.getElementById('add-maca')) === null || _e === void 0 ? void 0 : _e.addEventListener('click', () => {
        const itemMaca = new Itens("Maçã Dourada", 5, "Comida");
        meuJogo.adicionarItem(itemMaca);
    });
    // Botão para remover Terra
    (_f = document.getElementById('rmv-terra')) === null || _f === void 0 ? void 0 : _f.addEventListener('click', () => {
        meuJogo.removerItem("Terra", 5);
    });
    // Botão para remover Picareta
    (_g = document.getElementById('rmv-picareta')) === null || _g === void 0 ? void 0 : _g.addEventListener('click', () => {
        // Remove a primeira picareta que encontrar
        meuJogo.removerItem("Picareta de Diamante", 1);
    });
    // Novo: Adicionar picareta com Fortuna
    (_h = document.getElementById('add-picareta-fortuna')) === null || _h === void 0 ? void 0 : _h.addEventListener('click', () => {
        meuJogo.adicionarItem(new Itens("Picareta de Diamante", 1, "Ferramenta", 1561, "Fortuna"));
    });
    // Novo: Adicionar picareta com Toque de Seda
    (_j = document.getElementById('add-picareta-seda')) === null || _j === void 0 ? void 0 : _j.addEventListener('click', () => {
    ...
    (_k = document.getElementById('minerar-ferro')) === null || _k === void 0 ? void 0 : _k.addEventListener('click', () => {
        meuJogo.minerarBloco("Ferro");
    });
    // Conecta o botão de minerar ao nosso método
    (_l = document.getElementById('minerar-diamante')) === null || _l === void 0 ? void 0 : _l.addEventListener('click', () => {
        meuJogo.minerarBloco("Diamante");
    });
    // --- Listener para Ordenação ---
    // Listener para o botão de comparação por nome
    (_m = document.getElementById('sort-compare')) === null || _m === void 0 ? void 0 : _m.addEventListener('click', () => {
        meuJogo.compararOrdenacao();
    });
    // Listener para o botão de ordenação por durabilidade
    (_o = document.getElementById('sort-heap')) === null || _o === void 0 ? void 0 : _o.addEventListener('click', () => {
